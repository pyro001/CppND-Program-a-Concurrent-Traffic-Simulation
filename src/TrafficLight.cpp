...
{ 
    ...
    { 
        ...
        if(delay<std::chrono::duration_cast<std::chrono::milliseconds>(now_e).count())
        {
       ...
       lck.unlock();
        ...
        std::this_thread::sleep_for(std::chrono::milliseconds(LOOPUPDATEDELAY));
    }
